...
<template>
  <div class="space-y-6">
    ...
    <div v-if="store.isTaskListTab" class="grid gap-3 rounded-md border border-gray-200 bg-white p-4 shadow-sm lg:grid-cols-5">
    ...
    <div v-else-if="store.activeTab === 'resultList'" class="grid gap-3 rounded-md border border-gray-200 bg-white p-4 shadow-sm lg:grid-cols-6">
    ...
    <div v-else class="grid gap-3 rounded-md border border-gray-200 bg-white p-4 shadow-sm lg:grid-cols-4">
