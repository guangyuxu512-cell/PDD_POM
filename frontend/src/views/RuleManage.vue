  ...
  <div class="space-y-6">
    ...
    <Modal :show="showEditor" :title="editorTitle" width="min(88vw, 1100px)" @close="closeEditor">
      <form class="space-y-4" @submit.prevent="handleSave">
        <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          <label class="space-y-2 xl:col-span-2"><span class="text-xs font-medium text-gray-600">规则名称</span><input v-model="form.name" type="text" placeholder="请输入规则名称" class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" /></label>
          ...
          <label class="space-y-2"><span class="text-xs font-medium text-gray-600">优先级</span><input v-model.number="form.priority" type="number" min="0" class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" /></label>
        </section>
    ...
    <Modal :show="showTestMatch" title="测试规则匹配" width="min(72vw, 840px)" @close="closeTestMatchDialog">
      <div class="space-y-4">
        ...
        <label class="block space-y-2"><span class="text-xs font-medium text-gray-600">测试数据（JSON）</span><textarea v-model="testForm.dataText" rows="8" class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"></textarea></label>
